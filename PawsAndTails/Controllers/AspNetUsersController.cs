...
namespace PawsAndTails.Controllers
{
    public class AspNetUsersController : Controller
    {
        private readonly aspnetPawsAndTailsbf7e490958394e22832749b4b03c6426Context _context;

        public AspNetUsersController(aspnetPawsAndTailsbf7e490958394e22832749b4b03c6426Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AspNetUsers != null ? 
                          ...
                          Problem("Entity set 'aspnetPawsAndTailsbf7e490958394e22832749b4b03c6426Context.AspNetUsers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'aspnetPawsAndTailsbf7e490958394e22832749b4b03c6426Context.AspNetUsers'  is null.");
            }
            var aspNetUser = await _context.AspNetUsers.FindAsync(id);
            if (aspNetUser != null)
            {
