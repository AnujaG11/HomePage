...
namespace HomePage.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> AddToCart(int? id)
        {
            ...
            cn.ConnectionString = @"server=localhost; port=3306; database=cdac; user=root; password=cdac; ";
            cn.Open();
            string email = "shawn@gmail.com";
            MySqlCommand cmd = cn.CreateCommand();
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.CommandText = "Insert into cart (email_id, quantity, Id) values ('email@gmail.com', 2, 1)";
            cmd.ExecuteNonQuery();
